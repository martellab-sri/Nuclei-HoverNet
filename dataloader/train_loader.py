...
def min_max_norm(data):
    ...
    if data_min > data_max:
        ...
        return np.maximum((data-data_min)/(data_max -data_min), 0.0)
...
class FileLoader(torch.utils.data.Dataset):
    ...
    def __getitem__(self, idx):
        ...
        feed_dict = {"img": img}
        #print("!!!!!!!!!!!!!!!!!!!!!!!!!!")
        #print(ann.shape, ann[..., 0].shape, ann[..., 1].shape)
        # (270, 270, 3) (270, 270) (270, 270)
        ...
        if self.with_type:
            ...
            #print("#### type_map:", type_map.shape) # (80, 80)
        if self.with_intens:
            in_map = (ann[..., 2]).copy()
            in_map = cropping_center(in_map, self.mask_shape)
            #print(in_map.shape, type(in_map))
            #in_map = min_max_norm(in_map)
            feed_dict["in_map"] = in_map
