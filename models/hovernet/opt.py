...
def get_config(nr_type,intensity, mode):
    return {
        # ------------------------------------------------------------------
                ...
                "run_info": {
                    ...
                    "net": {
                        "desc": lambda: create_model(
                            ...
                            freeze=True, mode=mode, intensity=False
                        ),
                        "optimizer": [
                            optim.Adam,
                        ...
                        #"pretrained":"./pretrained/net_epoch=29.tar",
                    },
                },
            ...
            
            {
                "run_info": {
                    ...
                    "net": {
                        "desc": lambda: create_model(
                            input_ch=3, nr_types=nr_type, 
                            freeze=False, mode=mode, intensity=False
                        ),
                        "optimizer": [
                            optim.Adam,
                            {  # should match keyword for parameters within the optimizer
