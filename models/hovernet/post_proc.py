...
def __proc_np_hv(pred):
    ...
    #blb = remove_small_objects(blb, min_size=10)####hover_net segmentation
    blb = remove_small_objects(blb, min_size=3) #### detection
    ...
    ###marker = remove_small_objects(marker, min_size=10)   ## hover_net segmenttaion
    marker = remove_small_objects(marker, min_size=2)  ### detection
...
def process(pred_map, nr_types=None, return_centroids=False):
    ...
    return pred_inst, inst_info_dict#, pred_intens
