...
class Config(object):
    ...
    def __init__(self):
        ...
        # pannuke:nr_type= 6; monusac:nr_type= 5;
        ...
        #self.dataset_name = "kumar-stain" # extracts dataset info from dataset.py
        self.dataset_name = "aml"
        self.log_dir = "/labs3/amartel_data3/tingxiao/logs_AML_new/" # where checkpoints will be saved

        # paths to training and validation patches
        #self.train_dir_list = ["/labs3/amartel_data3/tingxiao/cells_patches/train"]
        #self.valid_dir_list = ["/labs3/amartel_data3/tingxiao/cells_patches/valid"]

        self.train_dir_list = ["/labs3/amartel_data3/tingxiao/hover_net/aml-intens-patches/train/540x540_164x164"]
        self.valid_dir_list = ["/labs3/amartel_data3/tingxiao/hover_net/aml-intens-patches/valid/540x540_164x164"]
        ...
        self.model_config = module.get_config(nr_type, self.intensity,model_mode)
